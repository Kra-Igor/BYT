...
public class Account {
	...
	public void removeTimedPayment(String id) {
		if(!timedPaymentExists(id)) throw new NullPointerException("Nie istnieje timepayment o takim id");//KTR add -> przy pisaniu testu jednostkowego testAddRemoveTimedPayment -> brakowa³o sprawdzenia, czy istnieje taki TimePayment
